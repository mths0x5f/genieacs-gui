...
function (_Component) {
  ...
  function FilterModal() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "renderFields", function (fields) {
      ...
      var rows = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Array(Math.ceil(fields.length / 2))); // chunk the products into the array of rows
      ...
      var content = productRows.map(function (row, idx) {
        return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_13__["Row"], {
          ...
          return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("article", {
            key: product,
            className: "col-md-3"
          }, product);
        }));
      });
      return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", null, content);
    });
...
//# sourceMappingURL=devices.js.240b93bbe23879ed73f6.hot-update.js.map